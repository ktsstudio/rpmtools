...
rpmbuild -bb generic_django.spec --define "name $name" --define "version $version" --define "release $release" --define "source $(cd ..;pwd)" --define "summary $summary" --define "requires $requires" --define "buildrequires $buildrequires" --define "wsgi $wsgi"
